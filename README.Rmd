...
```{r}
 prm.fcst = list(
  ...
  plot(g)
```
We can add a new hypothetical transmission scenario and then forecast
```{r}

B.date = date.start + c(-20:(hz+200)) # define beyond date.start +/- delta.start to avoid warnings
